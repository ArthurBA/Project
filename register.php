...
<table width="900" border="1" align="center">
  ...
  <tr>
    ...
    <td width="867">
    <i><p style="color:#F00">Please make sure that you enter correct email and password</p></i>
    <form name="form1" method="post" action="register.php" class"form" style="padding:15px 15px 15px 15px">
    <table width="460">
      <td width="452">
      </br>
      <table width="359">
        ...
        <tr>
          <td><br/><b>Email:</b>
            ...
            <input class='form-control' type="text" name='email' id="textfield3" ></td>
          </tr>
        <tr>
        ...
        <tr>
          <td><br/><a href="index.php">Sign in</a></td>
        </tr>
        <tr>
        	<td><br/>
            	<?php	
					if(isset($_POST['button']))
					{
						...
						$obj->registerMember($name,$surname,$password,$cPassword,$email,$address,$status);
					}
